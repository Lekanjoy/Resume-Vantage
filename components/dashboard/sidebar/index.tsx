...
const Sidebar = () => {
  ...
  return (
    <aside
      className={twMerge(
        "z-10 w-20 bg-[#1D0872] text-[#FAFAFA] flex flex-col gap-y-16 px-6 py-11 h-dvh lg:w-1/5 lg:items-center lg:px-8 lg:py-10 2xl:px-12",
        isToggle ? "w-full" : "w-20"
      )}
    >
      <div className="">
          <div className=" text-lg font-bold text-primary-100  absolute top-10 left-[104px] lg:text-[#FAFAFA] lg:text-xl lg:relative lg:top-0 lg:left-0">
            <span className="text-primary lg:text-[#D8CFFC]">Resume</span>Vantage.
          </div>
          <Image
