  ...
  return (
    <div
      ...
      className={twMerge(
        ...
        isChecked ? "border-primary bg-[#F7F5FE]" : "border-[#A3A3A3]"
      )}
    >
      ...
      <div className="flex flex-col max-w-[180px] lg:gap-y-1 lg:max-w-[280px]">
        <p className="font-semibold text-sm text-secondary lg:text-2xl">
          {title}
        </p>
        <p className="text-xs text-secondary-100 lg:text-base">{text}</p>
      </div>
      {isChecked && (
