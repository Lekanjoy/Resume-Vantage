...
const CTA = () => {
  return (
    <section className="relative w-full flex flex-col justify-center mb-20 items-center px-6 gap-y-4 text-center bg-[#7758F3] h-[550px] rounded-3xl lg:max-h-[400px] lg:text-left lg:items-start lg:px-10 lg:gap-y-6 2xl:px-14">
