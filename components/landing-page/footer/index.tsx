...
const Footer = () => {
  return (
    <footer
      className={`${openSans.className} w-full font-medium text-secondaryColor-100 text-sm mb-20 flex flex-col gap-y-16 ease-in-out duration-300 text-center px-6 lg:px-20  lg:text-left lg:gap-y-12 xl:px-[80px] 2xl:px-[120px] 2xl:gap-y-16`}
    >
      ...
      <div className="flex flex-col gap-y-8 items-center lg:justify-between lg:items-start lg:flex-row">
        ...
        <p className="font-normal">
          © 2024{" "}
          <span className="font-semibold text-primaryColor-100">Resume</span>
          <span className="text-primaryColor">Vantage. </span> All rights
          reserved.
        </p>
      </div>
    </footer>
